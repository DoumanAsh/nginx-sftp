...
- `HTTP_SERVE_FOLDER_RETENTION_DAYS` - Configures retention for files stored in `$HTTP_SERVE_FOLDER`
- `CLEANUP_INTERVAL_SECS` - Configures cleanup daemon to delete files older than `$HTTP_SERVE_FOLDER_RETENTION_DAYS`. Defaults to 24 hours (86400 seconds).
